...
void show_stat(Animal *animal) {
    std::cout << animal->name << " state" << std::endl;
    std::cout << "Health: " << animal->health << std::endl;
    std::cout << "Satiety: " << animal->food << std::endl;
    std::cout << "Cleanness: " << animal->clean << std::endl;
}
    ...
    for (;;) {
        ...
        switch (input) {
            ...
            case 1:
                ...
                break;
            case 2:
                std::cout << "Who do you play with?: ";
                std::cin >> play_with;
                if (play_with < animal_num) play(list[play_with]);
                break;
            case 3:
                std::cout << "Whose animal are you going to look at?: ";
                std::cin >> play_with;
